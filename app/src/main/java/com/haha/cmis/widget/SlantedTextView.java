...
public class SlantedTextView extends View {
    ...
    @NonNull
    private Path getModeLeftPath(@NonNull Path path, int w, int h) {
        path.moveTo(w, 0);
        path.lineTo(0, h);
    ...
    @NonNull
    private Path getModeRightPath(@NonNull Path path, int w, int h) {
        path.lineTo(w, h);
    ...
    @NonNull
    private Path getModeLeftBottomPath(@NonNull Path path, int w, int h) {
        path.lineTo(w, h);
    ...
    @NonNull
    private Path getModeRightBottomPath(@NonNull Path path, int w, int h) {
        path.moveTo(0, h);
    ...
    @NonNull
    private Path getModeLeftTrianglePath(@NonNull Path path, int w, int h) {
        path.lineTo(0, h);
        path.lineTo(w, 0);
        return path;
    }
    ...
    @NonNull
    private Path getModeRightTrianglePath(@NonNull Path path, int w, int h) {
        path.lineTo(w, 0);
        path.lineTo(w, h);
        return path;
    }
    ...
    @NonNull
    private Path getModeLeftBottomTrianglePath(@NonNull Path path, int w, int h) {
        path.lineTo(w, h);
        path.lineTo(0, h);
        return path;
    }
    ...
    @NonNull
    private Path getModeRightBottomTrianglePath(@NonNull Path path, int w, int h) {
        path.moveTo(0, h);
        path.lineTo(w, h);
        path.lineTo(w, 0);
        return path;
