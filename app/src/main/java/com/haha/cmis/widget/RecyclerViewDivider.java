...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RecyclerViewDivider(@NonNull Context context, int orientation) {
     ...
     */
    public RecyclerViewDivider(@NonNull Context context, int orientation, int drawableId) {
     ...
     */
    public RecyclerViewDivider(@NonNull Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
