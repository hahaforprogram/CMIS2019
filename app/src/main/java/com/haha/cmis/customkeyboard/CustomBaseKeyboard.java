...
public abstract class CustomBaseKeyboard extends Keyboard implements KeyboardView.OnKeyboardActionListener {
    ...
    public static class SimpleCustomKeyStyle implements CustomKeyStyle {
        ...
        @Nullable
        @Override
        public Drawable getKeyBackground(@NonNull Key key, EditText etCur) {
        ...
        @Override
        public CharSequence getKeyLabel(@NonNull Key key, EditText etCur) {
            return key.label;
        }

        protected int getKeyCode(@Nullable Context context, int resId) {
            if (null != context) {
        ...
        @Nullable
        protected Drawable getDrawable(@Nullable Context context, int resId) {
            if (null != context) {
