...
public class SystemBarTintManager {
    ...
    private void setupStatusBarView(Context context, @NonNull ViewGroup decorViewGroup) {
    ...
    private void setupNavBarView(Context context, @NonNull ViewGroup decorViewGroup) {
    ...
    public static class SystemBarConfig {
        ...
        @TargetApi(14)
        private int getActionBarHeight(@NonNull Context context) {
            int result = 0;
